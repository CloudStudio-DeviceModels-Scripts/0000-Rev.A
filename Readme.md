...
# Parsing + Configuration Script – 0000 - Rev. A

This **Parsing + Configuration** script is designed for the **0000** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – 0000 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **0000** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
